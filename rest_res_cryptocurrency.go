...
type CryptocurrencyCommon struct {
	...
	Tags                          []interface{}                  `json:"tags"`                             // Array of tags associated with this cryptocurrency. Currently only a mineable tag will be returned if the cryptocurrency is mineable. Additional tags will be returned in the future.
	...
	Platform                      CryptocurrencyPlatform         `json:"platform"`                         // Metadata about the parent cryptocurrency platform this cryptocurrency belongs to if it is a token, otherwise null.
	Quote                         map[string]CryptocurrencyQuote `json:"quote"`                            // A map of market quotes in different currency conversions. The default map included is USD.
}

type CryptocurrencyPlatform struct {
...
type CmcRestApiCryptocurrencyListingsLatestRes []CryptocurrencyCommon

type CmcRestApiCryptocurrencyQuotesLatestRes map[string]CryptocurrencyCommon
